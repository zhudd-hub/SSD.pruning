...
from model.utils.model_zoo import load_state_dict_from_url
...
class conv_bn_relu(nn.Sequential):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, groups=1):
        ...
        self.convbn=nn.Sequential(OrderedDict([
                ('conv', nn.Conv2d(in_planes, out_planes,kernel_size, stride, padding, bias=False)),
...
class MobileNetV2(nn.Module):
    def __init__(self, width_mult=1.0, inverted_residual_setting=None):
        ...
        features = [conv_bn_relu(3, input_channel, stride=2)]
        ...
        features.append(conv_bn_relu(input_channel, self.last_channel, kernel_size=1))
