...
from model.data.datasets.evaluation import evaluate

from model.utils import dist_util, mkdir
from model.utils.dist_util import synchronize, is_main_process
...
def compute_on_dataset(model, data_loader, device):
    ...
    for batch in tqdm(data_loader):
        ...
        # print('current device ',device) cuda
        with torch.no_grad():
